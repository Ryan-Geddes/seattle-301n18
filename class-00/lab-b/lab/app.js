...
// TODO: Uncomment the following line of code to see the output in the browser console
 console.log(objectLit('potato',3,'star wars'));
...
// it is the joe object
//
// 2. What is "this" when joe.scopeArrow() is invoked?
//// the window object
// 3. Explain why "this" is different when an arrow function is used.
//  THIS will not work with arrow functions.  When used in a traditional function, the 'this' refers to the object within the code block.
// When using an arrow function, the THIS now refers to the next outside object, which is the DOM window object.
